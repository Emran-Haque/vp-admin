...
export const navItems: NavItem[] = [
  ...
  { label: "অভিভাবক SMS", href: "/guardian-sms", icon: MessageSquare, permission: "can_send_guardian_sms" },
  ...
  // { label: "লেজার", href: "/ledger", icon: Wallet, permission: "can_view_orders" },
  ...
  { label: "ভিউ ম্যানেজমেন্ট", href: "/view-management", icon: PanelsTopLeft, permission: "can_manage_home_content" },
